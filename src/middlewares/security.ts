...
// API key validation middleware (optional for third-party integrations)
export const validateApiKey = (req: Request, res: any, next: any) => {
...
export const sanitizeInput = (req: Request, res: any, next: any) => {
